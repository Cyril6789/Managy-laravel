...
(function(){
	var // jQuery and jQueryUI version
		...
		opts = {
			url : './templates/v4/assets/elfinder/php/connector.minimal.php', // connector URL (REQUIRED)
		...
		start = function(elFinder) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('./templates/v4/assets/elfinder/jquery-ui.css');
