...
class MySQL
{
	...
	private $db_user    = "gi67_managy";          // user name
	private $db_pass    = "OHEuKr-DcV2.plR%=C";          // password
	private $db_dbname  = "gi67_managy";          // database name
	...
	*/
	...
	public function Query($sql) {
                ...
                $_SESSION['requetes']++;
                if($_SESSION['debug'])
                    echo 'Nouvelle requete '.$_SESSION['requetes'].' : '.$sql.'<br /><br />';
		$this->ResetError();
		$this->last_sql = $sql;
	...
	public function SQLFix($value) {
	    //echo $value.'ok<br />'.mysqli_real_escape_string($this->mysql_link, $value);
