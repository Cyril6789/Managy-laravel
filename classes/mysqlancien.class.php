...
class MySQLancien
{
	...
	private $db_user    = "gi67_extranet";          // user name
	private $db_pass    = "livres6167bchs";          // password
	private $db_dbname  = "gi67_extranet";          // database name
	...
	*/
	...
	public function Query($sql) {
                ...
                $_SESSION['requetes']++;
                if($_SESSION['debug'])
                    echo 'Nouvelle requete : '.$sql.'<br /><br />';
		$this->ResetError();
		$this->last_sql = $sql;
