...
class sellsyConnect
{
    ...
    private function __construct() {
        ...
        /*$this->oauth_access_token = $sellsy->sellsy_oauth_access_token;
        $this->oauth_access_token = $sellsy->sellsy_oauth_access_token_secret;
        $this->oauth_consumer_key = $sellsy->sellsy_oauth_consumer_key;
        $this->oauth_consumer_secret = $sellsy->sellsy_oauth_consumer_secret;*/



        $encoded_key = rawurlencode($sellsy->sellsy_oauth_consumer_secret).'&'.rawurlencode($sellsy->sellsy_oauth_access_token_secret);
        $oauth_params = array (
            'oauth_consumer_key' => $sellsy->sellsy_oauth_consumer_key,
            'oauth_token' => $sellsy->sellsy_oauth_access_token,
